  ...
  User.init(
    {
      ...
      role: { 
        ...
        defaultValue: "",
        validate: {
          isIn: [['admin', 'subadmin', 'agent', 'user', '']]
        }
      },
      phone: { 
        type: DataTypes.STRING,
      ...
      exposure: { type: DataTypes.FLOAT, defaultValue: 0 },
      exposureTime: { type: DataTypes.DATE, defaultValue: null },
      exposureLimit: { type: DataTypes.INTEGER, defaultValue: -200000 },
      wagering: { type: DataTypes.FLOAT, defaultValue: 0 },
      ip: DataTypes.STRING,
      user_agent: { type: DataTypes.STRING, defaultValue: "na" },
      is_active: { type: DataTypes.BOOLEAN, defaultValue: false },
      is_verified: { type: DataTypes.BOOLEAN, defaultValue: false },
      ...
      last_login: { type: DataTypes.DATE },
      token: { type: DataTypes.STRING, defaultValue: null },
      addedBy: { type: DataTypes.INTEGER, defaultValue: null },
      timezone: { 
        type: DataTypes.STRING, 
        defaultValue: "Asia/Kolkata",
        validate: {
          isIn: {
            args: [['Asia/Kolkata', 'UTC', 'America/New_York']], // Add more as needed
